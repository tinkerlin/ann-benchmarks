...
all_metrics = {
    ...
    "aqps": {
        "description": "Average Queries per second (1/s)",
        "function": lambda true_distances, run_distances, metrics, run_attrs: average_queries_per_second(true_distances, run_attrs),  # noqa
        "worst": float("-inf")
    },
    "wqps": {
